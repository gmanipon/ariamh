...
def main(args):
    if args[0] == 'validate_ifg':
        ...
        json.dump(mets,open(inps['meta_file'],'w'))
        #create input file for validate
        json.dump(inps,open('valid_ifg_in.json','w'))
        ...
        json.dump(mets,open(inps['meta_file'],'w'))
        #create input file for validate
        json.dump(inps,open('valid_ts_in.json','w'))
        ...
        json.dump(jdict,open('donwload_in.json','w'))
        ...
        jdict_st['']
        os.chdir(dirname)
        json.dump(jdict_st,open('ifg_stitch.json','w'))
