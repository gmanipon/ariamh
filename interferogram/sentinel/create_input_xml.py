...
def create_input_xml(tmpl_file, xml_file, master_safe_dir, slave_safe_dir,
                     ...
                     dem_file, swathnum, azimuth_looks, range_looks, bbox,
                     use_virtual_files, do_esd, esd_coherence_threshold):
...
def main():
    ...
    bbox = sys.argv[13]
    use_virtual_files = sys.argv[14]
    do_esd = sys.argv[15]
    esd_coherence_threshold = sys.argv[16]
